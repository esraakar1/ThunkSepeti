...
const Card = ({ restaurant }) => {
  return (
    ...
    className="relative shadow rounded-lg overflow-hidden card hover:bg-gray-200 hover:shadow-lg cursor-pointer transition"
  >
    ...
    <img
      ...
      className="w-full object-cover h-[250px] lg:h-[200px] rounded-t-sm"
    />
